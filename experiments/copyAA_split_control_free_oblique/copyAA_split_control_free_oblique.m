%% copyAA_split_control_free_oblique — fixed tracked axes + noise-optimal free extractor
...
fprintf('\ncopyAA split tracked/free noise-optimal PredVARX-SMPC results\n');
...
out.schema_version = 'copyAA_split_control_free_oblique_v1';
...
save(fullfile(results_dir,'copyAA_split_control_free_oblique_data.mat'), '-struct', 'out', '-v7.3');

fid = fopen(fullfile(results_dir,'copyAA_split_control_free_oblique_metrics.txt'), 'w');
fprintf(fid, 'copyAA_split_control_free_oblique metrics\n');
...
title(tlo, sprintf('copyAA split tracked/free PredVARX-SMPC (p=%d, ell=%d, free oblique %.1e)', p, ell, stats.free_oblique_norm));
print(fig, fullfile(results_dir,'copyAA_split_control_free_oblique_fig'), '-dpng', '-r160');
