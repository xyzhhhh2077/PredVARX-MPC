...
model=D.model; Ru=0.18*eye(m); Q=80*(Etask*Etask'); limit=D.y_max;
...
linkaxes([ax ax2 ax3 ax4 ax5],'x'); title(tl,sprintf('copyAV hard preference | selected outputs=%s | no new training set',mat2str(prefstats.selected_indices)));
