"""Verify the encoded copyBJ summary GIF and export a keyframe contact sheet."""
...
SHEET_PATH = RESULTS / "copyBJ_smpc_summary_keyframes.png"
REPORT_PATH = RESULTS / "copyBJ_smpc_summary_gif_audit.json"
EXPECTED_FRAMES = 200
...
def main():
    ...
    report = {
        ...
        "final_frame_edge_energy": float(
            np.abs(np.diff(final.astype(float), axis=1)).mean()
        ),
