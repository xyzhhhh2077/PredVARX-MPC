...
fprintf('\ncopyAL split empirical-total-cov free dual PredVARX-SMPC results\n');
...
out.schema_version = 'copyAL_split_empirical_cov_oblique_v1';
...
save(fullfile(results_dir,'copyAL_split_empirical_cov_oblique_data.mat'), '-struct', 'out', '-v7.3');

fid = fopen(fullfile(results_dir,'copyAL_split_empirical_cov_oblique_metrics.txt'), 'w');
fprintf(fid, 'copyAL_split_empirical_cov_oblique metrics\n');
...
title(tlo, sprintf('copyAL empirical free dual (alpha=%.2f, free oblique %.1e)', ...
    oblique_alpha, stats.free_oblique_norm));
print(fig, fullfile(results_dir,'copyAL_split_empirical_cov_oblique_fig'), '-dpng', '-r160');
