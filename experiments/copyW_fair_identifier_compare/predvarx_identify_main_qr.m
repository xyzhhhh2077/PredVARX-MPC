function [A_hat, B_hat, P_hat, Pbar_hat, R_hat, Rbar_hat, G_aug_hat, Sigma_eps_hat, Sigma_ebar_hat, F_aug_hat, H_aug_hat, lambda_forget, prewhiten] = predvarx_identify_main_qr(y_data, u_data, ell, beta_u, L_u, A_true, B_true, C_true, n, m, p)
